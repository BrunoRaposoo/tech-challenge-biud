...
export function TransactionForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} aria-label="Criar transação">
      <input {...register('accountExternalIdDebit')} aria-invalid={!!errors.accountExternalIdDebit} placeholder="accountExternalIdDebit (uuid)" />
      {errors.accountExternalIdDebit && <span role="alert">{errors.accountExternalIdDebit.message}</span>}
      <input {...register('accountExternalIdCredit')} aria-invalid={!!errors.accountExternalIdCredit} placeholder="accountExternalIdCredit" />
      {errors.accountExternalIdCredit && <span role="alert">{errors.accountExternalIdCredit.message}</span>}
      <input {...register('transferTypeId', { valueAsNumber:true })} placeholder="transferTypeId" type="number" />
